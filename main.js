document.addEventListener("DOMContentLoaded", () => {
  ...
  axios.get('https://crudcrud.com/api/d4b59b7348924d70ad183103040e5180/data')
    .then((response) => {
      ...
      candies.forEach((candy, index) => {
        ...
        buy1.addEventListener("click", () => {
          axios.delete(`https://crudcrud.com/api/d4b59b7348924d70ad183103040e5180/data/${candy._id}`)
            .then((response) => {
        ...
        let q = parseInt(listItem.textContent.split(" ")[3])-1
        let obj = {
        ...
        axios.post("https://crudcrud.com/api/d4b59b7348924d70ad183103040e5180/data", obj)
            .then((response) => {
              console.log(response);
              location.reload();
            })
            ...
            let q = parseInt(listItem.textContent.split(" ")[3])-2
            let obj = {
              "Candyname" : listItem.textContent.split(" ")[0],
              "Description" : listItem.textContent.split(" ")[1],
              "Price" : listItem.textContent.split(" ")[2],
            ...
            axios.post("https://crudcrud.com/api/d4b59b7348924d70ad183103040e5180/data", obj)
                ...
                let q = parseInt(listItem.textContent.split(" ")[3])-3
                let obj = {
                  "Candyname" : listItem.textContent.split(" ")[0],
                  "Description" : listItem.textContent.split(" ")[1],
                  "Price" : listItem.textContent.split(" ")[2],
...
sub.addEventListener("click", () => {
  ...
  axios.post('https://crudcrud.com/api/d4b59b7348924d70ad183103040e5180/data', object)
       .then((response)=>{
        console.log(response);
        location.reload();
